...
# -*- coding: utf-8 -*-
#
# pendula documentation build configuration file, created by
...
latex_documents = [
  ('index', 'pendula.tex', 'pendula Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'pendula', 'pendula Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'pendula', 'pendula Documentation',
   'Ariel Rokem', 'pendula', 'One line description of project.',
   'Miscellaneous'),
]
