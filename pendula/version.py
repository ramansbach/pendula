...
description = "pendula: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/pendula/blob/master/README.md

License
=======
``pendula`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/pendula"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
...
VERSION = __version__
PACKAGE_DATA = {'pendula': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
PYTHON_REQUIRES = ">= 3.5"
